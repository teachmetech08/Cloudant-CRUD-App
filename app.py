...
<head>
    ...
    padding-bottom: 80px; /* <--- ADD THIS LINE HERE */
}
        :root {
            --bg-primary: #0f172a;
            --bg-secondary: #1e293b;
...
<!-- Floating Blurry Glass Bottom Bar Layout -->
<footer style="position: fixed; bottom: 0; left: 0; width: 100%; display: flex; justify-content: space-between; align-items: center; padding: 15px 40px; border-top: 1px solid rgba(30, 41, 59, 0.7); color: #94a3b8; font-family: sans-serif; box-sizing: border-box; background-color: rgba(11, 19, 41, 0.85); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); z-index: 999999;">
    
    <!-- Left Side: Copyright Text -->
    <div style="font-size: 14px; letter-spacing: 0.5px;">
        &copy; 2026 Vansh Agarwal. All Rights Reserved.
    </div>

    <!-- Right Side: LinkedIn & GitHub Profile Icons -->
    <div style="display: flex; gap: 20px; align-items: center;">
        <!-- LinkedIn Link -->
        <a href="https://www.linkedin.com/in/vansh-agarwal-techpluss08" target="_blank" title="LinkedIn Profile" style="color: #94a3b8; text-decoration: none; transition: color 0.2s; display: flex; align-items: center;" onmouseover="this.style.color='#38bdf8'" onmouseout="this.style.color='#94a3b8'">
            <svg height="18" width="18" viewBox="0 0 24 24" fill="currentColor" style="display: block;">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
            </svg>
        </a>

        <!-- GitHub Link -->
        <a href="https://github.com/teachmetech08" target="_blank" title="GitHub Profile" style="color: #94a3b8; text-decoration: none; transition: color 0.2s; display: flex; align-items: center;" onmouseover="this.style.color='#38bdf8'" onmouseout="this.style.color='#94a3b8'">
            <svg height="19" width="19" viewBox="0 0 24 24" fill="currentColor" style="display: block;">
